class SymbolTable(object):
    ...
    symbol_table = {}
    next_line_index = 0 # the ROM address of the next line of code to be scanned during initialization
    next_var_index = 16 # the RAM address of the next variable to be stored in the symbol table, starting from index 16
